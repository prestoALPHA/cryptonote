// Copyright (c) 2011-2017 The Cryptonote developers pisa
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x7262b68;
...
const char     CRYPTONOTE_NAME[]                             = "pisa";
...
const int      P2P_DEFAULT_PORT                              = 36509;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 36506;
